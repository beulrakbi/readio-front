                    ...
                    <div>
                        <div className={PostCSS.postDetailReviewProDiv}>
                            ...
                            <div className={PostCSS.postDetailReviewProfile}>
                                <li>{reviewItem.profileId.penName || "익명"}</li> {/* 실제 데이터 필드명 사용 */}
                        ...
                        <div className={PostCSS.postDetailReviewLikeDiv}>
                            <p className={PostCSS.postDetailReviewLike}>좋아요 {reviewItem.postReviewLike || 0}</p> {/* 실제 데이터 필드명 사용 */}
                            <div className={PostCSS.postDetailReviewBtDiv}>
                                <button 
                                    onClick={() => onClickReviewDeleteHandler(reviewItem.postReviewId)} // <<< 핸들러 연결
