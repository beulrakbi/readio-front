        ...
        <div className={JoinCSS.joinPage}>
            ...
            <section className={JoinCSS.termsSection}>
                ...
                {isTermsModalOpen && (
                    <div className={JoinCSS.modalOverlay}>
                        <div className={JoinCSS.modalContent}>
                            ...
                            <button onClick={closeTermsModal} className={JoinCSS.closeBtn}>닫기</button>
                        </div>
                    </div>
                )}
                ...
                <div className={JoinCSS.checkboxGroup}>
                    ...
                    <button type="button" onClick={openPrivacyModal} className={JoinCSS.modalBtn}>
                        자세히 보기
                    </button>
                </div>
                ...
                {isPrivacyModalOpen && (
                    <div className={JoinCSS.modalOverlay}>
                        <div className={JoinCSS.modalContent}>
                            ...
                            <button onClick={closePrivacyModal} className={JoinCSS.closeBtn}>닫기</button>
                        </div>
                    </div>
                )}
