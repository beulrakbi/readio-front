    ...
    return (
        <div className={FeedCSS.feedDiv}>
            <div className={FeedCSS.feedRecDiv}>
                <button className={FeedCSS.feedRecBt}>추천</button>
                <button className={FeedCSS.feedFollowBt}>팔로잉</button>
            </div>
            <div className={FeedCSS.feedListBtDiv}>
                <button className={FeedCSS.feedAllBt}>전체</button>
                <button className={FeedCSS.feedPostBt}>포스트</button>
                <button className={FeedCSS.feedReviewBt}>리뷰</button>
